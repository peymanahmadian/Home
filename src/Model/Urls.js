...
export const Header=(isAthu,userID)=>{
    if(isAthu){
        if(userID){
            return {'Authorization':`Bearer ${LocalStorage.get("home_token")}`,'Content-Type':'application/json','UserId':userID};

        }else{
            return {'Authorization':`Bearer ${LocalStorage.get("home_token")}`,'Content-Type':'application/json'};
...
export const LevelOne={
    ...
    get:'http://pg.sandboxdevelop.ir/adv/api/CategoryLevelOne/GetCategoryLevelOne',
    post:'http://pg.sandboxdevelop.ir/adv/api/CategoryLevelOne/AddCategoryLevelOne',
    delete:'http://pg.sandboxdevelop.ir/adv/api/CategoryLevelOne/DeleteCategoryLevelOne',
    edit:'http://pg.sandboxdevelop.ir/adv/api/CategoryLevelOne/EditCategoryLevelOne'

}
export const LevelTwo={
    get:'http://pg.sandboxdevelop.ir/adv/api/CategoryLevelTwo/GetCategoryLevelTwoByLevelOneId',
    post:'http://pg.sandboxdevelop.ir/adv/api/CategoryLevelTwo/AddCategoryLevelTwo',
    delete:'http://pg.sandboxdevelop.ir/adv/api/CategoryLevelTwo/DeleteCategoryLevelTwo',
    edit:'http://pg.sandboxdevelop.ir/adv/api/CategoryLevelTwo/EditCategoryLevelTwo'
}
export const LevelThree={
    get:'http://pg.sandboxdevelop.ir/adv/api/CategoryLevelThree/GetCategoryLevelThreeByLevelTwoId',
    post:'http://pg.sandboxdevelop.ir/adv/api/CategoryLevelThree/AddCategoryLevelThree',
    delete:'http://pg.sandboxdevelop.ir/adv/api/CategoryLevelThree/DeleteCategoryLevelThree',
    edit:'http://pg.sandboxdevelop.ir/adv/api/CategoryLevelThree/EditCategoryLevelThree'
}
export const LevelThreeProperties={
    get:'http://pg.sandboxdevelop.ir/adv/api/PropertyCategory/GetPropertyCategoryByCategoryLevelThreeId',
    post:'http://pg.sandboxdevelop.ir/adv/api/PropertyCategory/AddPropertyCategory',
    delete:'http://pg.sandboxdevelop.ir/adv/api/PropertyCategory/DeletePropertyCategory',
    edit:'http://pg.sandboxdevelop.ir/adv/api/PropertyCategory/EditPropertyCategory'
}
export const City={
...
export const CityPart={
    get:'http://pg.sandboxdevelop.ir/adv/api/Neighborhood/GetNeighborhoodsByCityId',
...
export const Special={
    get:'http://pg.sandboxdevelop.ir/adv/api/SpecialPropertyCategory/GetSpecialPropertyByCategoryLevelOneId',
    post:'http://pg.sandboxdevelop.ir/adv/api/SpecialPropertyCategory/AddSpecialPropertyCategory',
    delete:'http://pg.sandboxdevelop.ir/adv/api/SpecialPropertyCategory/DeleteSpecialPropertyCategory',
    edit:'http://pg.sandboxdevelop.ir/adv/api/SpecialPropertyCategory/EditSpecialPropertyCategory'
}
