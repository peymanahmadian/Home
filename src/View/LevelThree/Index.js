            ...
            <Grid>
              <Table
                ...
                column={[
                  ...
                  {
                    title: "فیلد سطح شماره دوم",
                    field: "categoryLevelTwoName",
                    editable: "never",
                  },
                ...
                actions={{
                  onRowAdd: (newData) =>
                    new Promise((resolve, reject) => {
                      let body = {
                        ...newData,
                        IsActive: true,
                        CategoryLevelTwoId: selectedTwo,
                      };
                      axios
                        .post(LevelThree.post, body, { headers: Header(true) })
                        .then((response) => {
                          loadDataLevelThree(selectedTwo);
                          resolve();
                        })
                  ...
                  onRowUpdate: (newData) =>
                    new Promise((resolve) => {
                      let body = {
                        ...newData,
                        IsActive: true,
                        CategoryLevelTwoId: newData.categoryLevelTwoId,
                      };
                      axios
                        .put(LevelThree.edit, body, { headers: Header(true) })
                        .then((response) => {
                          loadDataLevelThree(selectedTwo);
                          resolve();
                        })
                  ...
                  onRowDelete: (oldData) =>
                    new Promise((resolve, reject) => {
                      ...
                      axios
                        .delete(LevelThree.delete + "/" + param, {
                          headers: Header(true),
                        })
                        .then((response) => {
                          loadDataLevelThree(selectedTwo);
