                ...
                actions={{
                    onRowAdd: newData =>
                        new Promise((resolve) => {
                            ...
                            axios.post(City.post,body,{headers:Header(true)}).then((response)=>{
                                loadData();
                                resolve()
                            }).catch(()=>{
                    ...
                    onRowUpdate: (newData, oldData) =>
                        new Promise((resolve) => {
                            let body={...newData,"IsActive":true};
                            axios.put(City.edit,body,{headers:Header(true)}).then((response)=>{
                                loadData();
                                resolve()
                            }).catch(()=>{
                    ...
                    onRowDelete: oldData =>
                        new Promise((resolve,reject) => {
                            ...
                            axios.delete(City.delete +"/"+ param,{headers:Header(true)}).then((response)=>{
                                loadData();
                                resolve();
                            }).catch((err)=>{
