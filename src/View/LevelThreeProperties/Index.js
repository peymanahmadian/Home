...
const Index = () => {
  ...
  const loadProperties = (select) => {
    if (select) {
      axios
        .get(`${LevelThreeProperties.get}/${select}`, { headers: Header(true) })
        .then((response) => {
          ...
          <Grid>
            <Table
              ...
              column={[
                { title: "شماره", field: "id", editable: "never" },
                {
                  ...
                  editComponent: (props) => (
                    <Select
                      value={
                        props.value &&
                        properties.find((pro) => (pro.name = props.value)).id
                      }
                ...
                {
                  title: "نام دسته بندی سطح سوم",
                  field: "categoryLevelThreeName",
                  editable: "never",
                },
                {
                  title: "فعال",
                  field: "isActive",
                  render: (rowdata) =>
                    rowdata.isActive === true ? <CheckIcon /> : <CloseIcon />,
                  editComponent: (props) => (
                    <Select
                      value={props.value}
                      onChange={(e) => props.onChange(e.target.value)}
              ...
              actions={{
                onRowAdd: (newData) =>
                  new Promise((resolve, reject) => {
                    let body = {
                      ...newData,
                      CategoryLevelThreeId: selectedThree,
                      propertyID: newData.propertyName,
                    };
                    axios
                      .post(LevelThreeProperties.post, body, {
                        headers: Header(true),
                      })
                      .then((response) => {
                        loadProperties(selectedThree);
                  ...
                  new Promise((resolve) => {
                    ...
                    let body = {
                      ...
                      PropertyId: properties.find(
                        (pro) => (pro.name = newData.propertyName)
                      ).id,
                      IsActive: newData.isActive,
                      CategoryLevelThreeId: newData.categoryLevelThreeId,
                    };
                    axios
                      .put(LevelThreeProperties.edit, body, {
                        headers: Header(true),
                      })
                      .then((response) => {
                        loadProperties(selectedThree);
                ...
                onRowDelete: (oldData) =>
                  new Promise((resolve, reject) => {
                    ...
                    axios
                      .delete(LevelThreeProperties.delete + "/" + param, {
                        headers: Header(true),
                      })
                      .then((response) => {
                        loadProperties(selectedThree);
