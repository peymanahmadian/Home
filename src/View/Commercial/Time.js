        ...
        actions={{
          onRowAdd: (newData) =>
            new Promise((resolve, reject) => {
              ...
              axios
                .post(CommercialTime.post, body, { headers: Header(true) })
                .then((response) => {
                  loadData();
                  resolve();
                })
          ...
          onRowUpdate: (newData, oldData) =>
            new Promise((resolve) => {
              let body = {
                PerDays: newData.perDay,
                Name: newData.name,
                Id: newData.id,
              };
              axios
                .put(CommercialTime.edit, body, { headers: Header(true) })
                .then((response) => {
                  loadData();
                  resolve();
                })
          ...
          onRowDelete: (oldData) =>
            new Promise((resolve, reject) => {
              ...
              axios
                .delete(CommercialTime.delete + "/" + param, {
                  headers: Header(true),
                })
                .then((response) => {
                  loadData();
