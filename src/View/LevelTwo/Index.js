...
const Index = () => {
  ...
  const loadDataLevelTwo = (one) => {
    ...
    if (one) {
      axios
        .get(`${LevelTwo.get}/${one}`, { headers: Header(true) })
        .then((response) => {
                ...
                actions={{
                  onRowAdd: (newData) =>
                    new Promise((resolve, reject) => {
                      ...
                      axios
                        .post(LevelTwo.post, body, { headers: Header(true) })
                        .then((response) => {
                          resolve();
                          loadDataLevelTwo(selectedOne);
                        })
                  ...
                  onRowUpdate: (newData) =>
                    new Promise((resolve) => {
                      let body = {
                        ...newData,
                        IsActive: true,
                        CategoryLevelOneId: newData.categoryOneId,
                      };
                      axios
                        .put(LevelTwo.edit, body, { headers: Header(true) })
                        .then((response) => {
                          loadDataLevelTwo(selectedOne);
                          resolve();
                        })
