      ...
      <Grid item xs={12}>
        ...
        <Switch>
          ...
          <Route
            exact={true}
            path={"/properties"}
            component={IndexProperties}
          />
          <Route
            exact={true}
            path={"/level/three/option"}
            component={IndexThreeProperties}
          />
          <Route
            exact={true}
            path={"/properties/option"}
            component={IndexPropertiesOpt}
          />
          <Route
            exact={true}
            path={"/properties/special"}
            component={IndexSpecial}
          />
          <Route exact={true} path={"/city/parts"} component={indexCityParts} />
          <Route
            exact={true}
            path={"/commercial/time"}
            component={indexTimer}
          />
          <Route
            exact={true}
            path={"/commercial/price"}
